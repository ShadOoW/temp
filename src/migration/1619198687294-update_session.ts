...
export class updateSession1619198687294 implements MigrationInterface {
    name = 'updateSession1619198687294'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "sessions"."duration" IS NULL`);
