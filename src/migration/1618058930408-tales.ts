...
export class tales1618058930408 implements MigrationInterface {
    name = 'tales1618058930408'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "firstName" character varying(300) NOT NULL, "lastName" character varying(300), "picture" character varying(300), "phoneNumber" character varying(300), "city" character varying(300), "company" character varying(300), "website" character varying(300), "linkedin" character varying(300), "country" character varying(300), "yearsOfExperience" integer, "domainExpertise" character varying(300), "coachingType" character varying(300), "coachingDomains" character varying array, "canOffer" text, "professionalBg" text, "hoursPerMonth" integer, "currentPost" character varying(300), "sector" character varying(300), "wantedDomain" character varying(300), "whyNeedCoaching" text, "selfDescription" text, CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`);
