...
export class quizTitle1622538456656 implements MigrationInterface {
    name = 'quizTitle1622538456656'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "quizSolutions" ALTER COLUMN "title" DROP NOT NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "quizSolutions"."title" IS NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "quizzes"."createdAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "quizSolutions"."title" IS NULL`);
        await queryRunner.query(`ALTER TABLE "quizSolutions" ALTER COLUMN "title" SET NOT NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "quizSolutions"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "quizSolutions"."createdAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "balances"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "balances"."createdAt" IS NULL`);
