...
export class updateProfile1623063360547 implements MigrationInterface {
    name = 'updateProfile1623063360547'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "profiles" ADD "facebook" character varying(300)`);
        await queryRunner.query(`ALTER TABLE "profiles" ADD "twitter" character varying(300)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "permissions"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "permissions"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "profiles" DROP COLUMN "twitter"`);
        await queryRunner.query(`ALTER TABLE "profiles" DROP COLUMN "facebook"`);
    }
